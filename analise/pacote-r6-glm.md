# Rodada 6 — REVISÃO DE EXECUÇÃO. Eixo negócio.

O painel foi construído (123 bairros de Teresina, geometria e dado real — Anexo 1). A análise está
triplamente verificada. O que resta é execução, com ~106 dias até 31/12.

Plano proposto: PISTA 1 (reunião de escopo com o proponente; e-SIC para ETURB/SEMDUH/Águas/SEAD;
e-mail à Foxinline propondo parceria; revalidar RREO) em paralelo à PISTA 2 (conector CADURB, INEP,
verificação fiscal de Altos, dossiê de dispensa). Calendário: M0 até 15/10 · vender diagnóstico de
R$ 3–5 mil em **5–10 municípios** entre 16/10 e 15/11 · contratos e remessas 15/11–20/12.

Responda no máximo 6 achados, só o que muda:

1. **A meta de 5–10 diagnósticos vendidos em 30 dias é realista** para uma empresa sem referência
   anterior no setor público municipal? Se não, qual meta e por quê — e o que fazer para que errar a
   meta não contamine a leitura da tese.
2. **O timing da reunião com a Foxinline.** Propor parceria ANTES de ter uma remessa aceita é chegar
   sem ativo de troca? Ou a janela exige falar agora? Recomende e justifique.
3. Com o painel pronto e verificável, **qual é a sequência de reuniões** que maximiza conversão:
   prefeito, secretário de fazenda, secretário de planejamento, APPM, TJ-PI? Ordene e diga por quê.
4. O plano tem 4 e-SIC (ETURB, SEMDUH, Águas de Teresina, SEAD/PROUrbe). **Falta algum pedido
   crítico?** Considere que o produto é conformidade CIB, não painel — e que a lista de adesões ao
   SINTER por município pode ser pedida à RFB.
5. **O que fazer nos 30 dias em que os e-SIC estão correndo** e ainda não há resposta? Qual trabalho
   comercial não depende deles.
6. Veredito sobre o plano de execução: aprovar como está, aprovar com ajustes (quais), ou refazer.
