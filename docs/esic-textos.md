# Textos de e-SIC — prontos para envio (rev. 16/09/2026 v2)

Prioridade conforme o plano: **RFB** (denominador do mercado) e **SEAD** (fecha a
cega do PROUrbe); ETURB/SEMDUH/Águas de Teresina servem à vitrine (enviar depois).

> **MORTO POR DESIGN (v2): o antigo item 2 (SEFAZ-PI — "estimativa anual do IBS
> 2027–2032 por município, com metodologia" + "impacto da ausência de CIB").**
> Pedido que exige **elaboração de estudo** não é acesso a documento existente →
> resposta previsível de "pedido indevido" consumindo os 15+10 dias. A linha de
> R$/município que ele buscaria **já existe publicada no SICONFI**: ITBI por
> município (receita realizada, código 1.1.2.1.02.xx, MSCC) — transação imobiliária
> é a receita que o CIB trava **hoje**. Ver `dados/bruto/siconfi/` e a rodada 8
